...
class BiliLive(object):
    __slots__ = ['room_id', 'user_cookie', 'http_proxy', 'wx_proxy', '_user_id', '_user_login_status',
                 'session', '_ws', '_heart_beat_task', '_cmd_func']

    def __init__(self, room_id, user_cookie=None, cmd_func_dict=None, loop=None,
                 connector=None, http_proxy=None, wx_proxy=None):
        ...
        try:
            while binary:
                ...
                if operation == WS_OP_MESSAGE:
                    ...
                    print('直播间 {} 连接成功'.format(self.room_id))
